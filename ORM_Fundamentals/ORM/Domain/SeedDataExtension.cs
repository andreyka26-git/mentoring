    ...
    public static class SeedDataExtension
    {
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            var books = new List<Book>
            {
                ...
                new() {Id = 2, CreatedDateTime = DateTime.Now, Name = "Book1", Author = "Author2"},
                new() {Id = 3, CreatedDateTime = DateTime.MaxValue, Name = "Book1", Author = "Author2"},
            };

            var reviews = new List<Review>
            {
                new() {Id = 1, BookId = 1, Mark = 4, ReviewDateTime = DateTime.Now, ReviewerName = "Name1"},
                new() {Id = 2, BookId = 1, Mark = 2, ReviewDateTime = DateTime.Now, ReviewerName = "Name2"},
